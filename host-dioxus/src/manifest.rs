...
mod tests {
    ...
    fn parse_and_validate_accepts_comment_and_reports_unknown_group() {
        let content = r#"
        {
          ...
          "characters": {
            "groups": {
              "hero": { "anchor": { "x": 0.5, "y": 1.0 }, "pre_scale": 1.0 }
            },
            "sprites": { "characters/villain.png": "missing_group" }
          },
          "presets": { "center": { "x": 0.5, "y": 0.95, "scale": 1.0 } },
          "defaults": { "anchor": { "x": 0.5, "y": 1.0 }, "pre_scale": 1.0 }
        }
        "#;
