...
- 作者：Ring-rs 开发组
- 日期：2026-03-10
- 相关范围：`docs/script_syntax_spec.md`、`vn-runtime/src/script/parser/`、`vn-runtime/src/command/mod.rs`、`host/src/command_executor/`
...
1. 更新 `docs/script_syntax_spec.md`：§4.1 对话语法增加内联差分形式，§5.3 `show` 说明中注明与内联差分的分工
2. 更新解析器，增加对应测试用例（含：有差分/无差分/旁白/alias 未绑定错误）
3. 更新 Command 定义与 Host executor
4. 更新 `docs/module_summaries/` 对应摘要
...
- [ ] 解析器新增对应测试用例
- [ ] `docs/script_syntax_spec.md` 完成更新
